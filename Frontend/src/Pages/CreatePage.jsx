...
const handleRoute = () =>{
  ...
  {options.map((opt) => (
    <div className={`bg-[#1f1f1f] border border-[#3f3f3f] rounded-lg p-6 flex flex-col items-center text-center justify-center cursor-pointer transition ${
        selected === opt.id
    ...
    <div className='flex flex-col items-center mt-16'>
        ...
        {!selected? (
            <div>
                ...
                <p className='text-gray-400 text-sm text-center'>Upload and record at home or on the go.
