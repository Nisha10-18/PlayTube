...
function PlayShort() {
  ...
  useEffect(() => {
    if (allShortsData.length === 0) return;
  ...
  return (
    <div className="h-[100vh] w-full overflow-y-scroll snap-y snap-mandatory">
      {shortList.map((short, index) => (
        ...
        >
          <div
            className="relative w-[420px] md:w-[350px] aspect-[9/16] bg-black rounded-2xl md:mt-[0px] 
            overflow-hidden shadow-xl border border-gray-700 cursor-pointer"
