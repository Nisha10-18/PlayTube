...
function ShortCard({ shortUrl, title, channelName, avatar, views, id }) {
  ...
  return (
    <div className="w-45 sm:w-48 cursor-pointer relative" onClick={()=>navigate(`/playshort/${id}`)}>
      {/* Video Container */}
      <div className="rounded-xl overflow-hidden bg-black w-full h-70 border-1 border-gray-700 relative">
        <video
          src={shortUrl}
      ...
      {/* Overlay Content */}
      <div className="mt-2 space-y-2 w-full absolute bottom-0 p-3 bg-[#000000cf] rounded-xl">
